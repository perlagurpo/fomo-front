export default function FeaturedEventCard() {
  ...
  return(
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-8 mx-auto ">
      ...
      <div className="p-5">
        <a href="#">
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Mario y los Marios</h5>
        </a>
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Mario y los marios tocan en el club tri y la van a romper</p>
